...
function loadEnv() {
  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    if (fs.existsSync(productionEnvPath)) {
      envPaths.push(productionEnvPath);
    } else {
      // eslint-disable-next-line no-console
      console.log('No .env.production file found in root directory. Exiting...');
      process.exit(1);
    }
    ...
    console.log('Environment variables for production injected!');
    return;
  }
